...
class ColorUtils {
    companion object {
        ...
        val backGroundGradientColors = listOf(
            androidx.compose.ui.graphics.Color(android.graphics.Color.parseColor("#14213d")),
            androidx.compose.ui.graphics.Color(android.graphics.Color.parseColor("#000000")),
        )
    }
}